# -*- coding: utf-8 -*-
"""
SedaDizi (senadizi.com) - Otomatik Asya Dizi & Embed Kaynak Çekici Bot
Telif & DMCA Uyumlu: Yalnızca 3. taraf açık akış ve embed oynatıcı URL'lerini indeksler.
"""
...
# Örnek Güncel Asya Dizi Veritabanı ve Embed Akış Şablonları
ASIAN_DRAMA_FEED = [
    {
        "id": 1,
        "slug": "squid-game-2",
        ...
        "cast": [
            ...
            { "name": "Wi Ha-joon", "role": "Hwang Jun-ho", "img": "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=200&q=80" }
        ],
        "episodes": [
            {
                "episode_number": 1,
    ...
    },
    {
        ...
        "desc": "Sang Zhi'nin lise yıllarında ağabeyinin üniversite arkadaşı Duan Jiaxu'ya platonik olarak başlayan hisleri, yıllar sonra üniversite kampüsünde yeniden karşılaştıklarında saf ve tatlı bir aşka dönüşür.",
        "cast": [
    ...
    },
    {
        ...
        "desc": "Tarihte ve haritalarda var olmayan kurgusal Daeho ülkesinde, beden değiştiren tehlikeli büyü yüzünden kaderleri birbirine bağlanan genç büyücülerin destansı aşk ve intikam öyküsü.",
        "cast": [
    ...
    },
    {
        ...
        "desc": "Seçkin bir özel okula bursla kabul edilen Gorya'nın, okulun en zengin dört erkeğinden oluşan F4 grubunun zorbalığına karşı başlattığı cesur direniş.",
        "cast": [
    ...
    },
    {
        ...
        "desc": "İşitme engelli bir ailenin tek duyan çocuğu olan müzik dehası Eun Gyeol, zamanda yolculuk yaparak 1995 yılına döner ve genç yaştaki babasıyla bir grup kurar.",
        "cast": [
    ...
    },
    {
        ...
        "poster": "https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=600&q=80",
        "backdrop": "https://images.unsplash.com/photo-1534447677768-be436bb09401?w=1920&q=80",
        "desc": "Alt kademe bir çiçek perisi olan Xiao Lanhua ile kadim iblis lordu Dongfang Qingcang arasındaki büyüleyici mitolojik aşk.",
        "cast": [
    ...
    },
    {
        ...
        "backdrop": "https://images.unsplash.com/photo-1509198397868-475647b2a1e5?w=1920&q=80",
        "desc": "Hyosan Lisesi zombi salgınından kurtulan gençler, Seul şehrine yayılan yeni mutant virüs dalgasına karşı son insanlık kalesini savunmak zorundadır.",
        "cast": [
...
def run_cron_bot():
    print(f"[{datetime.now(timezone.utc).isoformat()}] [CRON BOT] Asya dizileri ve embed kaynak taraması başlatıldı...")
    
    # Canlı veri derleme
    data = {
        "last_updated": datetime.now(timezone.utc).isoformat(),
        "source": "https://dramafilix.cc/tr",
        "platform_name": "SedaDizi (senadizi.com) - Asya & Kore Dizi Platformu",
        "dmca_notice": "No video files are hosted on our servers. All videos are embedded from third-party sources.",
        "total_series": len(ASIAN_DRAMA_FEED),
        "series": ASIAN_DRAMA_FEED
    }

    with open(OUTPUT_JSON, "w", encoding="utf-8") as f:
        json.dump(data, f, ensure_ascii=False, indent=2)

    print(f"[{datetime.now(timezone.utc).isoformat()}] [CRON BOT BAŞARILI] {len(ASIAN_DRAMA_FEED)} Asya dizisi ve embed oynatıcı URL'leri diziler.json dosyasına kaydedildi.")
    return data
